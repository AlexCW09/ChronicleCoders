...
func chapterFour() {
    ...
    if respectServants{
        if momAlive {
            ...
            if exploreUpstairs && !kingHealed{
                showStory(generateStoryElements(story.healFamily))
            }
        }
    } else {
